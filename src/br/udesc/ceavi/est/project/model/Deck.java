...
public class Deck {
    ...
    public void createDeck() {
        ...
        deck.add(card);
        card = new Card("Barionix", 8.0f, 12.0f, 2000.0f, 125.5f);
        deck.add(card);
        card = new Card("Triceratopo", 6.0f, 9.0f, 6000.0f, 64.0f);
        deck.add(card);
        card = new Card("Ultrassauro", 22.0f, 38.0f, 9000.0f, 154.0f);
        deck.add(card);
        card = new Card("Tiranossauro (T)", 5.6f, 14.0f, 7000.0f, 68.0f);
        deck.add(card);
        card = new Card("Patagossauro", 8.7f, 18.0f, 16000.0f, 169.0f);
        deck.add(card);
        card = new Card("Brachiossauro", 15.0f, 28.0f, 5000.0f, 156.0f);
        deck.add(card);
        card = new Card("Pterodactilo", 0.1f, 1.9f, 1.1f, 140.0f);
        deck.add(card);
        card = new Card("Velociraptor", 1.0f, 2.0f, 80.0f, 80.0f);
        deck.add(card);
        card = new Card("Estegossauro", 4.0f, 9.0f, 4000.0f, 159.0f);
        deck.add(card);
        card = new Card("Dilofossauro", 2.5f, 8.0f, 450.0f, 206.0f);
        deck.add(card);
        card = new Card("Diplodoco", 5.0f, 27.0f, 2500.0f, 157.0f);
        deck.add(card);
        card = new Card("Melanorossauro", 12.0f, 15.0f, 8000.0f, 220.0f);
        deck.add(card);
        card = new Card("Compsognato", 0.9f, 1.3f, 2.5f, 170.0f);
        deck.add(card);
        card = new Card("Baptornis", 0.8f, 1.0f, 7.0f, 83.0f);
        deck.add(card);
        card = new Card("Psitacossauro", 0.7f, 2.0f, 25.0f, 125.0f);
        deck.add(card);
        card = new Card("Procompsognato", 0.4f, 1.2f, 1.0f, 222.0f);
        deck.add(card);
    }
